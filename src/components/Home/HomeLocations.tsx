...
export function HomeLocations() {
  ...
  useEffect(() => {
    // When navigating away and back in the SPA, object elements can briefly
    // show their raw SVG state before effects rerun. Reset readiness so the
    // map only appears after styling is applied again.
