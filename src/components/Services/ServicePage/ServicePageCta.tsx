...
/**
 * Closing CTA band. Reuses the same gradient-and-van visual language as
 * `HomeCta.tsx` so every page ends on a consistent, recognisable note,
 * while the heading/body copy stays unique per service.
 */
export function ServicePageCta({ heading, body, bookingLabel }: ServicePageCtaProps) {
